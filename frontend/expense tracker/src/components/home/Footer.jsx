                ...
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><Link to="/" className="hover:text-indigo-600 transition">About<span className="text-xs text-white bg-indigo-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span></Link></li>
                        </ul>
                    </div>
                    <div>
                        <p className="text-slate-100 font-semibold">Legal</p>
                        <ul className="mt-2 space-y-2">
                            <li><Link to="/" className="hover:text-indigo-600 transition">Privacy</Link></li>
                            <li><Link to="/" className="hover:text-indigo-600 transition">Terms</Link></li>
                        </ul>
                    </div>
                </div>
