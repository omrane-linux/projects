...
const Testimonials = () => {
  return (
    <section id="testimonials" className="bg-black py-20">
      <h2 className="text-3xl font-semibold text-center text-white mb-12">What Our Users Say</h2>
      <div className="flex flex-wrap items-center justify-center gap-6">
                <div className="max-w-80 bg-black text-white rounded-2xl">
                    ...
                    <div className="px-4 pb-4">
                        <p className="font-medium border-b border-gray-600 pb-5">“The financial reports are so clear and automated. Managing expenses has never been this effortless”</p>
                ...
                <div className="max-w-80 bg-black text-white rounded-2xl">
                    ...
                    <div className="px-4 pb-4">
                        ...
                        <p className="mt-4">— Henry Frats</p>
                        <p className="text-sm font-medium bg-gradient-to-r from-[#8B5CF6] via-[#E0724A] to-[#9938CA] text-transparent bg-clip-text">Product Designer</p>
                    </div>
                </div>
                <div className="max-w-80 bg-black text-white rounded-2xl">
                    <div className="relative -mt-px overflow-hidden rounded-2xl">
                    ...
                    <div className="px-4 pb-4">
                        <p className="font-medium border-b border-gray-600 pb-5">“Investing used to confuse me. Now I get simple, actionable insights every day.”</p>
                        <p className="mt-4">— Sara Fernandes</p>
                        <p className="text-sm font-medium bg-gradient-to-r from-[#8B5CF6] via-[#E0724A] to-[#9938CA] text-transparent bg-clip-text">Entrepreneur</p>
                    </div>
                </div>
            </div>
    </section>
